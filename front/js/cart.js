// On crée une IIFE pour éviter les collisions de nom
(function() {
    const key = 'Products';
     ...
     * @param {Object} products - Tableau des produits stockés en localStorage
     */
    ...
    function computeTotalPrice() {
        ...
        for (let i = 0; i < products.length; i++){
            let cartPrice = products[i].quantity * productsFromApi[i].price;
        ...
        showTotalPrice.textContent = getCartTotalPrice.reduce(reducerPrice, 0);
    }
